...
Ogni smartphone ed ogni computer possiedono una porta per consentire il collegamento: uno smartphone si può collegare ad un altro smartphone oppure ad un computer. Stabilito il collegamento, è possibile trasferire il Token. In per distinguere il ``\emph{Building}" dalle ``\emph{Room}", si è disegnato il primo tramite doppie linee.  
...
Equivalentemente, ritorna True  $\Leftrightarrow \forall S_i$ $(MC,S_i \models W_B(T,T,T) )$.
\end{prop}
