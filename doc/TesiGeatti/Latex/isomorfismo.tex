...
\section{Complessità}\label{sub:isoComplexity}
Il problema dell'isomorfismo tra bigrafi, come si è visto, è stato affrontato tramite il \emph{constraint programming}. Si è scelta questa tecnica per i seguenti motivi:
\begin{itemize}
	\item
