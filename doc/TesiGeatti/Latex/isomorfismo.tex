...
La preparazione dei dati è stata condotta con attenzione: si è implementato un metodo che potesse generare bigrafi casuali con il numero di nodi richiesto, per fare in modo che il tempo di risoluzione non dipendesse dalla struttura del bigrafo, che può essere semplice o complessa. Si vedranno due grafici: 
\begin{itemize}
	\item
	...
	\item
	il secondo rappresenta il \emph{tempo d'esecuzione} (figura \ref{fig:workingTime}), cioè quanto tempo impiega la libreria \emph{Choco vs 3.3.1} per risolvere il sistema di equazioni
\end{itemize}
