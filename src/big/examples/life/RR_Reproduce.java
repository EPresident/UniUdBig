...
/**
 * Rewriting Rule for cell rebirth
 * @author EPresident <prez_enquiry@hotmail.com>
 */
public class RR_Reproduce extends RewRuleWProps {
    ...
    private static Bigraph generateRedex() {
        ...
        // Neighbors
        Node[] neighbors = addNeighbors(3, subject, (Node) r, builder);
    ...
    private static Bigraph generateReactum() {
        ...
        // Subject
        Node subject = builder.addNode("deadCell", r, null, linkL);
        builder.addSite(subject);
