...
/**
 * Rewriting Rule for switching the state from compute next cell states to 
 * update cells.
 * @author EPresident <prez_enquiry@hotmail.com>
 */
public class RR_StartUpdating extends RewRuleWProps {
    ...
    private static Bigraph generateRedex() {
        ...
        Node u = builder.addNode("nextStateUncomputed", r);
