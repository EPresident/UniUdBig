...
/**
 * Rewriting Rule for cell staying dead for overpopulation
 *
 * @author EPresident <prez_enquiry@hotmail.com>
 */
public class RR_StayDead_OverPop extends RewRuleWProps {
    ...
    private static Bigraph generateRedex() {
        ...
        // Subject
        Node subject = builder.addNode("deadCell", r, null, linkU);
        builder.addSite(subject);

        // Neighbors
        Node[] neighbors = addDeadNeighbors(6, subject, (Node) r, builder);

        // Doesn't matter how the last two cells are
        OuterName linkN6 = builder.addOuterName("linkN6"),
                linkN7 = builder.addOuterName("linkN7");
        Node l1 = builder.addNode("link", subject, linkN6);
        Node l2 = builder.addNode("link", subject, linkN7);
        builder.addSite(l1);
        builder.addSite(l2);
    ...
    private static Bigraph generateReactum() {
        ...
        // Neighbors
        Node[] neighbors = addLiveNeighbors(4, subject, (Node) r, builder);

        // Doesn't matter how the last four cells are
        OuterName linkN4 = builder.addOuterName("linkN4"),
                linkN5 = builder.addOuterName("linkN5"),
                linkN6 = builder.addOuterName("linkN6"),
                linkN7 = builder.addOuterName("linkN7");
        Node l1 = builder.addNode("link", subject, linkN4);
        Node l2 = builder.addNode("link", subject, linkN5);        
        Node l3 = builder.addNode("link", subject, linkN6);
        Node l4 = builder.addNode("link", subject, linkN7);
        builder.addSite(l1);
        builder.addSite(l2);
        builder.addSite(l3);
        builder.addSite(l4);
