 ...
 */
public class RR_BrowsePage extends RewritingRule {
    ...
    private static Bigraph generateRedex() {
        ...
        bb.addSite(page);
        Node locus = bb.addNode("locus", page);
        bb.addSite(locus);
        ...
        bb.addSite(page);
        Node locus = bb.addNode("locus", page, user.getPort(0).getHandle());
        bb.addSite(locus);
