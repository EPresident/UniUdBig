 ...
 */
public class RR_ChangePageFromForm extends RewritingRule {
    ...
    private static Bigraph generateRedex() {
        ...
        Node form = bb.addNode("linkForm", locus, page2Link);
        bb.addNode("validInput", form);
