...
/**
 * Class for the entry of a packet in a firewall. The packet must have a token (TokenIN) linked to 
 * the list of permissions of the firewall.
 * 
 ...
 *
 */
public class FWINRule extends RewritingRule{
	...
	public FWINRule(Bigraph redex, Bigraph reactum, InstantiationMap map){
