...
/**
 * Class that allows a packet to exit from a firewall. The packet must have a TokenOUT linked to firewall's
 * list of permissions. 
 * 
 * This rule is applicable both in case that the firewall is the sender's one or the receiver's one.
 * Furthermore it can be applied also if the firewall is the router's one.
 * 
 ...
 *
 */
public class FWOUTRule extends RewritingRule{
	...
	public FWOUTRule(Bigraph redex, Bigraph reactum, InstantiationMap map){
