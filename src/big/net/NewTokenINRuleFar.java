 ...
 * 
 * This rule is applicable only if the packet and the firewall are in the same root. 
 * 
 * @see FWINRule
 * @author Luca Geatti <geatti.luca@spes.uniud.it>
 *
 */
public class NewTokenINRuleFar extends RewritingRule {
	...
	public NewTokenINRuleFar(Bigraph redex, Bigraph reactum,
