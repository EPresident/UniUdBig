 ...
 * firewall's list.
 *
 * This rule is applicable only if the packet and the firewall are in different
 * roots.
 *
 * @see FWOUTRule
 ...
 *
 */
public class NewTokenOUTRuleFar extends RewRuleWProps {
