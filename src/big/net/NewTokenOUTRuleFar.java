 ...
 * 
 * This rule is applicable only if the packet and the firewall are in different roots. 
 * 
 * @see FWOUTRule
 * @author Luca Geatti <geatti.luca@spes.uniud.it>
 *
 */
public class NewTokenOUTRuleFar extends RewritingRule {
	...
	public NewTokenOUTRuleFar(Bigraph redex, Bigraph reactum,
	...
	public static Bigraph getRedex(Signature signature) {
		...
		Node receiver = builder.addNode("stackNode", r2, idR, downR);
	...
	public boolean isApplicable(Bigraph bigraph, Signature signature) {
		...
		if (iter.hasNext()) {
			...
			String idR = getOuterNameImage("receiver", match, 0);
